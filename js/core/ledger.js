...
(function (global) {
  ...
  var Ledger = {
    ...
    attributionText: function (report, mediaPath) {
      ...
      L.push('Recorded by MediaRade (by sgtsilicon). Evidence of due diligence, not legal advice.');
      return L.join('\r\n');
    },
    ...
    appendCredits: function (report, mediaPath) {
      ...
      if (!Paths.exists(file)) {
        Paths.write(file, [
          '# Credits',
          '',
          'Generated by MediaRade (by sgtsilicon). Every entry below carries a licence',
    ...
    exportReport: function () {
      ...
      var lines = [
        ...
        '',
        'Generated ' + new Date().toISOString() + ' by MediaRade (by sgtsilicon).',
        '',
        '| Metric | Count |',
        '| --- | --- |',
