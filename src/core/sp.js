...
const UPLOADED = { any: 0, hour: 1, today: 2, week: 3, month: 4, year: 5 };

const TYPE = { any: 0, video: 1, channel: 2, playlist: 3, movie: 4 };

/* YouTube's own ordering here is genuinely short=1, long=2, medium=3. */
const DURATION = { any: 0, short: 1, long: 2, medium: 3 };
...
export const SP = {
  ...
  build: function (o) {
    ...
    const up = UPLOADED[o.uploaded] || 0;
    const ty = TYPE[o.type === undefined ? 'video' : o.type] || 0;
    const du = DURATION[o.duration] || 0;
