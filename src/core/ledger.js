...
export const Ledger = {
  ...
  record: function (entry) {
    ...
    const row = Object.assign({
      ...
      panel: 'MediaRade ' + __APP_VERSION__,
  ...
  attributionText: function (report, mediaPath) {
    ...
    L.push('Recorded by MediaRade (by ' + __APP_AUTHOR__ + '). Evidence of due diligence, not legal advice.');
    return L.join('\r\n');
  },
  ...
  appendCredits: function (report, mediaPath) {
    ...
    if (!Paths.exists(file)) {
      Paths.write(file, [
        '# Credits',
        '',
        'Generated by MediaRade (by ' + __APP_AUTHOR__ + '). Every entry below carries a licence',
  ...
  exportReport: function () {
    ...
    const lines = [
      ...
      '',
      'Generated ' + new Date().toISOString() + ' by MediaRade (by ' + __APP_AUTHOR__ + ').',
      '',
      '| Metric | Count |',
      '| --- | --- |',
